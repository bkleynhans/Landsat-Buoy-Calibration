...
def buildModel(args):
    ...
    if settings.USE_MYSQL:
        db_operator = db_operations.Db_Operations()
        batch_f_model(args, args.scene_txt, scenes, args.save, args.display_image, db_operator, args.caller, status_logger, output_logger)
    else:
        batch_f_model(args, args.scene_txt, scenes, args.save, args.display_image, args.caller, status_logger, output_logger)
