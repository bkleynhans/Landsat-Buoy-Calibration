...
def parseArgs(args):
    ...
    parser.add_argument('-t', '--type', default='url', choices=['url', 'file', 'directory'], help='Choose the type of path we are checking, choices:[url, file]')
